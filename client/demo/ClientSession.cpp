...
int ClientSession::SaveLocalNatInfo(int i_iNatType,const char * i_strPublicIP,int i_iPublicPort)
{
    ...
    {
        STUN_LOGE("SaveLocalNatInfo err i_iNatType %d ,i_iPublicPort %d \r\n",i_iNatType,i_iPublicPort);
        return iRet;
    }
    STUN_LOGI("SaveLocalNatInfo NatType %d ,PublicIP %s,PublicPort %d \r\n",i_iNatType,i_strPublicIP,i_iPublicPort);
...
int ClientSession::ReportResultCb(void *i_pReportObj,int i_iNatType,const char * i_strPublicIP,int i_iPublicPort)
{
    ...
    if(NULL == i_strPublicIP)
    {
        STUN_LOGE("ReportResultCb err i_iNatType %d ,i_iPublicPort %d \r\n",i_iNatType,i_iPublicPort);
        return iRet;
    }
...
int ClientSession::ParsePeerNatInfoRes(char * i_strMsg,const char * i_strPeerID,int * o_iNatType,char * o_strPublicIP,int i_iIPBufMaxLen,int * o_iPublicPort)
{
    ...
    if(NULL == i_strMsg||NULL == i_strPeerID||NULL == o_iNatType||NULL == i_strPublicIP||NULL == o_iPublicPort)
    {
...
* 2020/01/13      V1.0.0              Yu Weifeng       Created
******************************************************************************/
int ClientSession::ParsePeerSendMsgRes(char * i_strMsg,const char * i_strPeerID,char * o_pcResBuf,int i_iBufMaxLen)
{
    int iRet = -1;
    char strPeerID[64];
    char strPublicIP[64];
    ...
    if(NULL == i_strMsg||NULL == i_strPeerID||NULL == i_strPeerID||NULL == o_pcResBuf)
    {
...
* 2020/01/13      V1.0.0              Yu Weifeng       Created
******************************************************************************/
int ClientSession::ParseReportResultRes(char * i_strMsg,char * i_strLocalID,char * i_strPeerID,int * o_iSuccessCnt,int * o_iFailCnt)
{
    int iRet = -1;
    char strPeerID[64];
    char strLocalID[64];

    if(NULL == i_strMsg||NULL == o_iSuccessCnt||NULL == o_iFailCnt)
    {
